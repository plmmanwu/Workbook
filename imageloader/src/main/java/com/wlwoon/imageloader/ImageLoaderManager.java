...
public class ImageLoaderManager {
    private volatile static  ImageLoaderManager INSTANCE = null;
    ...
    public void trimMemory(Context context,int level) {
        getLoaderstrategy(curLoader).trimMemory(context,level);
    }

    public void clearDiskCache(Context context) {
        getLoaderstrategy(curLoader).clearDiskCache(context);
    }

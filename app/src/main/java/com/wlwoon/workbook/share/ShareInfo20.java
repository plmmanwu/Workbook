...
@Entity(nameInDb = "ShareInfo20_DB")
public class ShareInfo20 extends BaseInfo{
    ...
    @Generated(hash = 1057307483)
    public ShareInfo20(String shareId, String shareName, long shareNum,
            double sharePercent) {

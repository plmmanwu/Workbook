...
@Entity(nameInDb = "ShareInfo5_DB")
public class ShareInfo5 extends BaseInfo{
    ...
    @Generated(hash = 1087003088)
    public ShareInfo5(String shareId, String shareName, long shareNum,
            double sharePercent) {

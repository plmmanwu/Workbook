...
@Entity(nameInDb = "ShareInfo10_DB")
public class ShareInfo10 extends BaseInfo{
    ...
    @Generated(hash = 478083242)
    public ShareInfo10(String shareId, String shareName, long shareNum,
            double sharePercent) {
